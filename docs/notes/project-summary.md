...
- Athlete Training Schedule includes a month board so athletes can see the full month of programs in the main view. Tapping a day or workout selects that date/workout and keeps the detailed workout panel below in sync.

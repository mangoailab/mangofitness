...
- Athlete Training Schedule includes a month board only in phone landscape so athletes can see the full month of programs there. Portrait keeps the compact week strip. Tapping a day or workout selects that date/workout and keeps the detailed workout panel below in sync.
